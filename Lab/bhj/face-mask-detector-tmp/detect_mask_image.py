...
'''
base_path = os.getcwd()
face_path = os.path.sep.join([base_path,"face_detector"])
...
model_path =os.path.sep.join([base_path,"mask_detector.model"])
#model = load_model(args["model"])
model = load_model(model_path)

# load the input image from disk, clone it, and grab the image spatial
# dimensions
image_path = os.path.sep.join([base_path,"examples\example_01.png"])
